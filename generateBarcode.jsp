...
<script type='text/javascript'>
    function HandleCategoryChange()
    {
        ...
        xmlhttp.open ( 'POST', 'ajax_generateBarcode.jsp', true )
    ...
    {
        document.getElementById ( 'imgBarcode' ).src = 'BarcodeManager.jsp?barcode=' + barcode
    }
</script>
    ...
    <div class='line'>
        <div class='box'>
            <div class='margin2x'>
                ...
                <tr>
                    <td><center><img id='imgBarcode' /></center></td>
                </tr>
                <tr>
                    ...
                    <%
                        ...
                        if ( arrProductInformation != null )
                        {
                            ...
                            for ( int productIndex = 0; productIndex != arrProductInformation.length; ++productIndex )
                            {
                                ...
                                out.println ( "                        <td><input type='button' value='Generate Barcode' onclick='GenerateBarcode(\"" + productID + "\")' /></td>" );
                                out.println ( "                    </tr>" );
                            }
                        }
                    %>
